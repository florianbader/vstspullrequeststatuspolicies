  ...
  plugins: [
    ...
    new ConcatPlugin({
      ...
      filesToConcat: [
        ...
        "node_modules\\tippy.js\\dist\\tippy.js"
      ]
    }),
    new InsertConcatAssetsWebpackPlugin(["scripts"]),
    ...
    new HtmlWebpackPlugin({
      template: "./src\\project-admin.html",
      filename: "./project-admin.html",
      hash: false,
      inject: false,
      compile: true,
      favicon: false,
    ...
    new HtmlWebpackPlugin({
      template: "./src\\collection-admin.html",
      filename: "./collection-admin.html",
      hash: false,
      inject: false,
      compile: true,
      favicon: false,
